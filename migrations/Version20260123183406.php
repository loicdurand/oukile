 ...
 */
final class Version20260123183406 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piece ADD CONSTRAINT `FK_44CA0B233DA5256D` FOREIGN KEY (image_id) REFERENCES media_object (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
